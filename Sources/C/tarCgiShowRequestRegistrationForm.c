...
/* This file will generate the tarShowRequestRegistrationForm.cgi which will generate the HTML code for the Registrarion Form Page */
#include      <stdio.h>
#include      <stdlib.h>
...
/*
 * tarErrorType TarCgiShowRequestRegistrationForm ( tarErrorType var1 , tarLanguageType var2 ) ;
 *
 * Arguments:
 *
 *
...
tarErrorType TarCgiShowRequestRegistrationForm ( tarLanguageType tarLanguageMain )
{
