...
/* This file will generate the tarShowRequestRegistrationForm.cgi which will generate the HTML code for the Web Help Page */
#include      <stdio.h>
#include      <stdlib.h>
...
/*
 * tarErrorType TarCgiShowWebHelp ( tarErrorType var1 , tarLanguageType var2 ) ;
 *
 * Arguments:
 *
 *
...
tarErrorType TarCgiShowWebHelp ( tarLanguageType tarLanguageMain )
{
