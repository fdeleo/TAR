...
/* This file will generate the tarShowRequestRegistrationForm.cgi which will generate the HTML code for the License Page */
#include      <stdio.h>
#include      <stdlib.h>
...
/*
 * tarErrorType TarCgiShowLicense ( tarErrorType var1 , tarLanguageType var2 ) ;
 *
 * Arguments:
 *
 *
